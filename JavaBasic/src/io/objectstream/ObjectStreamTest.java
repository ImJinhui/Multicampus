			...
			// "읽어오기" 버튼이 눌렸을 
				...
				*/
				...
				try {
					...
					Record temp = (Record)ois.readObject();
					tfName.setText(temp.getName());
					tfAge.setText(String.valueOf(temp.getAge()));
					tfHeight.setText(String.valueOf(temp.getHeight()));
					tfBloodType.setText(String.valueOf(temp.getBloodType()));
